...
public class ParserP3Test {

    @Test
    public void testParseP3_01() throws IOException {
        // Read and process the test file
        String requestContent = ParserTestHelper.readTestFile("request_p3_01.txt");
        ...
        assertEquals("P3", header.getTransactionCode());
